...
internal fun pluginResultsToPrimitiveData(results: List<SweetSQLiteModule.SQLitePluginResult>): List<Any> =
  results.map(::convertPluginResultToArray)

private fun convertPluginResultToArray(result: SweetSQLiteModule.SQLitePluginResult): List<Any?> {
